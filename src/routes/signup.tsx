...
export const Route = createFileRoute("/signup")({
  ...
  head: () => ({
    meta: [
      { title: "Create Account — VoltX" },
      { name: "description", content: "Create your VoltX account and start shopping." },
    ],
  }),
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="w-full">
        <Card className="glass-card border-none">
          <CardHeader className="text-center">
            ...
            <CardDescription>Join VoltX and start shopping premium electronics</CardDescription>
          </CardHeader>
